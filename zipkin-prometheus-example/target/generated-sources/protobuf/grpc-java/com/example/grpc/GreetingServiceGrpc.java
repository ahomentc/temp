...
public final class GreetingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpc.HelloRequest,
      com.example.grpc.HelloResponse> getSecondGreetingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "secondGreeting",
      requestType = com.example.grpc.HelloRequest.class,
      responseType = com.example.grpc.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.grpc.HelloRequest,
      com.example.grpc.HelloResponse> getSecondGreetingMethod() {
    io.grpc.MethodDescriptor<com.example.grpc.HelloRequest, com.example.grpc.HelloResponse> getSecondGreetingMethod;
    if ((getSecondGreetingMethod = GreetingServiceGrpc.getSecondGreetingMethod) == null) {
      synchronized (GreetingServiceGrpc.class) {
        if ((getSecondGreetingMethod = GreetingServiceGrpc.getSecondGreetingMethod) == null) {
          GreetingServiceGrpc.getSecondGreetingMethod = getSecondGreetingMethod = 
              io.grpc.MethodDescriptor.<com.example.grpc.HelloRequest, com.example.grpc.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.example.grpc.GreetingService", "secondGreeting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.HelloResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new GreetingServiceMethodDescriptorSupplier("secondGreeting"))
                  .build();
          }
        }
     }
     return getSecondGreetingMethod;
  }
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void secondGreeting(com.example.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.HelloResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getSecondGreetingMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getSecondGreetingMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.example.grpc.HelloRequest,
                com.example.grpc.HelloResponse>(
                  this, METHODID_SECOND_GREETING)))
          .build();
    }
  }
  ...
  public static final class GreetingServiceStub extends io.grpc.stub.AbstractStub<GreetingServiceStub> {
    ...
    public void secondGreeting(com.example.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.HelloResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getSecondGreetingMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public com.example.grpc.HelloResponse secondGreeting(com.example.grpc.HelloRequest request) {
      return blockingUnaryCall(
          getChannel(), getSecondGreetingMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractStub<GreetingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.HelloResponse> secondGreeting(
        com.example.grpc.HelloRequest request) {
      return futureUnaryCall(
          getChannel().newCall(getSecondGreetingMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_GREETING = 0;
  private static final int METHODID_SECOND_GREETING = 1;
      ...
      switch (methodId) {
        case METHODID_GREETING:
          serviceImpl.greeting((com.example.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.HelloResponse>) responseObserver);
          break;
        case METHODID_SECOND_GREETING:
          serviceImpl.secondGreeting((com.example.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.HelloResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (GreetingServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getSecondGreetingMethod())
              .build();
        }
      }
    }
