...
public final class MetricsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.server.streaming.Streaming.Metric,
      com.example.server.streaming.Streaming.Average> getCollectMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "collect",
      requestType = com.example.server.streaming.Streaming.Metric.class,
      responseType = com.example.server.streaming.Streaming.Average.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.example.server.streaming.Streaming.Metric,
      com.example.server.streaming.Streaming.Average> getCollectMethod() {
    io.grpc.MethodDescriptor<com.example.server.streaming.Streaming.Metric, com.example.server.streaming.Streaming.Average> getCollectMethod;
      ...
      synchronized (MetricsServiceGrpc.class) {
        if ((getCollectMethod = MetricsServiceGrpc.getCollectMethod) == null) {
          MetricsServiceGrpc.getCollectMethod = getCollectMethod = 
              io.grpc.MethodDescriptor.<com.example.server.streaming.Streaming.Metric, com.example.server.streaming.Streaming.Average>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "com.example.server.streaming.MetricsService", "collect"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.server.streaming.Streaming.Metric.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.server.streaming.Streaming.Average.getDefaultInstance()))
  ...
  public static abstract class MetricsServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.example.server.streaming.Streaming.Metric> collect(
  ...
  private static abstract class MetricsServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.server.streaming.Streaming.getDescriptor();
    }
