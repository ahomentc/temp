...
public final class EchoServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.example.echo.EchoService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.example.echo.EchoOuterClass.Echo,
      com.example.echo.EchoOuterClass.Echo> getEchoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "echo",
      requestType = com.example.echo.EchoOuterClass.Echo.class,
      responseType = com.example.echo.EchoOuterClass.Echo.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.echo.EchoOuterClass.Echo,
      com.example.echo.EchoOuterClass.Echo> getEchoMethod() {
    io.grpc.MethodDescriptor<com.example.echo.EchoOuterClass.Echo, com.example.echo.EchoOuterClass.Echo> getEchoMethod;
      ...
      synchronized (EchoServiceGrpc.class) {
        if ((getEchoMethod = EchoServiceGrpc.getEchoMethod) == null) {
          EchoServiceGrpc.getEchoMethod = getEchoMethod = 
              io.grpc.MethodDescriptor.<com.example.echo.EchoOuterClass.Echo, com.example.echo.EchoOuterClass.Echo>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.example.echo.EchoService", "echo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.echo.EchoOuterClass.Echo.getDefaultInstance()))
  ...
  public static abstract class EchoServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void echo(com.example.echo.EchoOuterClass.Echo request,
        io.grpc.stub.StreamObserver<com.example.echo.EchoOuterClass.Echo> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.example.echo.EchoOuterClass.Echo,
                com.example.echo.EchoOuterClass.Echo>(
                  this, METHODID_ECHO)))
          .build();
    }
  ...
  public static final class EchoServiceBlockingStub extends io.grpc.stub.AbstractStub<EchoServiceBlockingStub> {
    ...
    /**
     */
    public com.example.echo.EchoOuterClass.Echo echo(com.example.echo.EchoOuterClass.Echo request) {
  ...
  public static final class EchoServiceFutureStub extends io.grpc.stub.AbstractStub<EchoServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.echo.EchoOuterClass.Echo> echo(
        com.example.echo.EchoOuterClass.Echo request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ECHO:
          serviceImpl.echo((com.example.echo.EchoOuterClass.Echo) request,
              (io.grpc.stub.StreamObserver<com.example.echo.EchoOuterClass.Echo>) responseObserver);
          break;
        default:
  ...
  private static abstract class EchoServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.echo.EchoOuterClass.getDescriptor();
    }
